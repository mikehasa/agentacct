...
// data; the versioned fixture flags render deterministic dashboard or menu
// review matrices without network or account data. Anything else launches the app.

if let flagIndex = CommandLine.arguments.firstIndex(of: "--snapshot-menu-fixture") {
