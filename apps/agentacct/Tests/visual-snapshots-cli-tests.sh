...
#!/usr/bin/env bash
case "$1" in
  -productVersion) echo "${AGENTACCT_FAKE_OS_VERSION:-26.6.2}" ;;
  -buildVersion) echo "${AGENTACCT_FAKE_OS_BUILD:-25G83}" ;;
  *) exit 1 ;;
esac
EOF
...
platform_id="macos-26.6.2-25G83-xcode-26.6-17F113-arm64-2x"
