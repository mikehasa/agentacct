...
final class WorkVisualRegressionTests: XCTestCase {
    ...
    private let expectedFilenames = [
        ...
        "work-retained-list-error-reference-light.png",
        "work-retained-list-error-reference-dark.png",
        "work-attention-overflow-reference-light.png",
        "work-attention-overflow-reference-dark.png",
