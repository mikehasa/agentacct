...
final class SourcesVisualRegressionTests: XCTestCase {
    private let expectedFilenames = [
        "sources-retained-error-minimum-light.png",
        "sources-retained-error-minimum-dark.png",
        "sources-retained-error-reference-light.png",
        "sources-retained-error-reference-dark.png",
    ]

    @MainActor
    func testSourcesRetainedErrorReviewMatrix() throws {
