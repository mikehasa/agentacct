...
final class SourcesVisualRegressionTests: XCTestCase {
    // Independent of the renderer configuration: removing a lane or
    // appearance must be an explicit contract change.
    private let expectedFilenames = [
        "sources-healthy-reference-light.png",
        "sources-healthy-reference-dark.png",
        "sources-degraded-reference-light.png",
        "sources-degraded-reference-dark.png",
    ]

    @MainActor
    func testDiagnosticsReviewMatrix() throws {
        ...
        let outputDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("agentacct-sources-visuals-\(UUID().uuidString)")
