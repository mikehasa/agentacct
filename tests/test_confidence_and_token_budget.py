...
def test_public_docs_describe_subscription_estimate_as_approximate() -> None:
    ...
    assert "agentacct cost subscription-estimate" in readme
    ...
    assert "explicit approximation, not as exact provider billing" in readme
    assert "Provider invoices or exposed provider usage data remain the source of truth" in readme
