...
def test_work_event_http_transport_writes_v1_and_v2(tmp_path) -> None:
    ...
    request = {
        ...
        "progress": "Wrote the v2 shadow layer beside the v1 path. Done; next: compare the two stores.",
...
def test_work_event_http_accepts_handed_off_as_a_clean_terminal_status(tmp_path) -> None:
    ...
    response = client.post(
        ...
        json={
            ...
            "progress": "Recorded where the HTTP work stands. Handed off to the next session.",
...
def test_evidence_claimed_links_route_contract(tmp_path) -> None:
    ...
    response = client.post(
        ...
        json={
            ...
            "status": "completed",
            "summary": "Recorded outcome for this HTTP work-event fixture.",
            "progress": "Linked the phase-5 claim to its evidence. Done.",
            "section_id": "phase-5",
            "title": "Fixture section title",
            "client_session_id": "session-1",
        },
    ...
    for index in range(5):
        response = client.post(
            ...
            json={
                ...
                "status": "completed",
                "summary": "Recorded outcome for this HTTP work-event fixture.",
                "progress": "Stored one page of work events for pagination. Done.",
    ...
    for index, source in enumerate(("codex", "claude-code", "codex", "claude-code", "codex")):
        response = client.post(
            ...
            json={
                ...
                "status": "completed",
                "summary": "Recorded outcome for this HTTP work-event fixture.",
                "progress": "Wrote a filterable work event for this source. Done.",
